...
#        return
    ...
    def EM_parameters_distribute(self, datat data_missing, PyFactorTree fiti_old, list rows, list weights, double alpha = 0.0):
        cdef vector[int] rows_v, weights_v
        cdef vector[int] cluster_v
        cdef vector[double] se
    ...
    def EM_parameters(self, datat data_missing, PyFactorTree fiti_old, list rows, list weights, double alpha = 0.0, list var_update = None):
        cdef vector[int] rows_v, weights_v
        cdef vector[int] cluster_v
        cdef vector[double] se
        cdef list list_se
