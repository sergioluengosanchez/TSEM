...
from sem import sem_tractable
from sem_soft import sem_soft_tractable, sem_soft_fast
import numpy as np
...
# Learn model with TSEM-hard
_, _, cppet, df_completed, _ = sem_tractable(data_incomplete, metric='ll',k_complex=0.1, tw_bound=5, custom_classes = var_classes)
# Learn model with TSEM
_, _, cppet, df_completed, _ = sem_soft_tractable(data_incomplete, metric='ll',k_complex=0.05, tw_bound=5, custom_classes = var_classes)
# Learn model with TSEM, using fast heuristic
_, _, cppet, df_completed, _ = sem_soft_fast(data_incomplete, metric='ll',k_complex=0.05, tw_bound=5, custom_classes = var_classes)
